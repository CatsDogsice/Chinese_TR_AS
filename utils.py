f"""Utilities, e.g., training/model arguments."""
...
class ModelArguments:
    ...
    tokenizer_name_or_path: str = field(
        default='/root/bert_chinese_base', metadata={"help": "Path to pretrained model or model identifier from huggingface.co/models"}
    )
    ...
    use_crf: bool = field(default=True, metadata={"help": "whether to use the crf for decoding."})
...
class DataTrainingArguments:
    ...
    data_dir: str = field(
       default=None, metadata={"help": "The input data dir. Should contain the .txt files for a CoNLL-2003-formatted task."}
    )
